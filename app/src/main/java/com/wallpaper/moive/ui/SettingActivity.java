...
import com.wallpaper.moive.view.wheelview.WheelView;
...
public class SettingActivity extends Dy_BaseActivity {
    ...
    private void initView() {
        ...
        itemVoice.getSwitch().setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                String service = sharedPreferencesUtil.getString("service", Dy_MainActivity.SERCIVE_1);
                if (isChecked) {
                    if (service.equals(Dy_MainActivity.SERCIVE_1))
    ...
    private void onFinish() {
        if (isUpdate)
            setResult(Dy_MainActivity.REQUEST_UPDATE_DURATION);
        else if (sortUpdate)
            setResult(Dy_MainActivity.REQUEST_UPDATE_SORT);
        finish();
    }
}
