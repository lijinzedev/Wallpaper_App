...
import com.wallpaper.moive.adapter.TabFragmentAdapter;
import com.wallpaper.moive.base.Dy_BaseActivity;
import com.wallpaper.moive.ui.SettingActivity;
import com.wallpaper.moive.ui.VideoFragment;
import com.wallpaper.moive.util.QMUIDialogUtils;
import com.wallpaper.moive.util.ToastUtils;
import com.wallpaper.moive.util.VideoUtil;
...
public class Dy_MainActivity extends Dy_BaseActivity {
    ...
    public static final String SERCIVE_1 = "com.wallpaper.moive.service.VideoLiveWallpaper";
    public static final String SERCIVE_2 = "com.wallpaper.moive.service.VideoLiveWallpaper2";
    ...
    private void initView() {
        topBar.addRightImageButton(R.drawable.mz_titlebar_ic_setting_dark, 100).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Dy_MainActivity.this, SettingActivity.class);
...
//        CURRENT_SORT = SharedPreferencesUtil.getInstance().getInt("sort",0);
    ...
    public boolean isLiveWallpaperChanged() {
        WallpaperManager wallpaperManager = WallpaperManager.getInstance(Dy_MainActivity.this);// 得到壁纸管理器
